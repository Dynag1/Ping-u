...
### Accès Local
```
http://localhost:5000/          # Page de monitoring
http://localhost:5000/admin     # Page d'administration
http://localhost:5000/login     # Page de connexion
```

### Accès Réseau
```
http://<ip-serveur>:5000/admin
```
