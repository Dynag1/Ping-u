...
*Si vous êtes sur un autre PC du réseau, remplacez `localhost` par l'adresse IP du PC où Ping ü est installé (ex: `http://192.168.1.15:5000/admin`).*
...
* **L'interface ne s'ouvre pas ?** Vérifiez que le port **5000** n'est pas bloqué par un pare-feu.
